...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = 'actProcessController.do?list&pageNo='+n+'&pageSize='+s;
        }
...
<body>
	...
	<form id="searchForm" action="actProcessController.do?list" method="post" class="breadcrumb form-search">
