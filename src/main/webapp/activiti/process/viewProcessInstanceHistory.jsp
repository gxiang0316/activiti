...
<div region="center" style="padding: 1px;">
	<img src="actProcessController.do?traceImage&processInstanceId=${processInstanceId}&isIframe">
</div>
<div data-options="region:'south',split:true" style="height:180px;">
	...
	<script type="text/javascript">
		...
		$('#taskHistoryList').datagrid({
	        ...
	        fitColumns:true,
	        showFooter:true,
	        url:'actTaskController.do?taskHistoryList&processInstanceId=${processInstanceId}',  
